...
Template.ThreeWayOriginalDemo.onCreated(function() {
	parentTemplate = this;
	this.num = new ReactiveVar(1);
});

Template.ThreeWayOriginalDemo.onRendered(function() {
...
Template.ThreeWayOriginalDemo.helpers({
	ready: () => sub.ready(),
...
Template.ThreeWayOriginalDemo.events({
...
// Child Template
////////////////////////////////////////////////////////////
Template.ThreeWayOriginalDemo_Child.onCreated(function() {
	var instance = this;
...
Template.ThreeWayOriginalDemo_Child.helpers({
	allowThirdGrandchild: () => Template.instance().allowThirdGrandchild.get(),
	vmDataGrandChild: (x) => _.object([
		['grandchildData', x]
	]),
});
...
////////////////////////////////////////////////////////////
grandchildTemplates = [];
Template.ThreeWayOriginalDemo_GrandChild.onCreated(function() {
	grandchildTemplates.push(this);
});
Template.ThreeWayOriginalDemo_GrandChild.onRendered(function() {
	var instance = this;
...
////////////////////////////////////////////////////////////
Template.ThreeWayOriginalDemo_PreparationDeficient.onRendered(function() {
